...
def rotationX(angle):
    ...
    - angle: rotation angle around x-axis, following right-hand rule. [rad]
    """
    return np.array(
        [[1, 0, 0],
...
def rotationY(angle):
    ...
    - angle: rotation angle around y-axis, following right-hand rule. [rad]
    """
    return np.array(
...
def rotationZ(angle):
    ...
    - angle: rotation angle around z-axis, following right-hand rule. [rad]
    """
    return np.array(
